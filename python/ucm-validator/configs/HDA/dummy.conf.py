...
SUPPRESS_IF = {
  ...
  "HDA-Intel/HDA-Intel.conf@HiFi.conf: 'If'.'analog'.'True'.'If'.'acp'.'Condition' - True": 1,
  ...
  "HDA-Intel/HDA-Intel.conf@HiFi.conf: 'If'.'hdmi'.'True'.'Include'.'hdmi'.'If'.'hdmi6'.'True'.'Include'.'hdmi6'.'If'.'hdmi'.'Condition' - True": 1,
